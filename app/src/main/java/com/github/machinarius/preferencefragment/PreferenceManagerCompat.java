 ...
 * same license, nothing changed in the code.
 *
 */
public class PreferenceManagerCompat {
	
	private static final String TAG = com.github.machinarius.preferencefragment.PreferenceManagerCompat.class.getSimpleName();
