...
public class AsciiTable
{
    ...
    public static class Cell
    {
         ...
         * 
         * @see AsciiTable#NO_ALIGNMENT
         * @see AsciiTable#LEFT_ALIGNMENT
         * @see AsciiTable#RIGHT_ALIGNMENT
         */
        int alignment;
    ...
    public static String[] splitForNewline(String pStr)
    {
        ...
        String[] retStrArr = (String[]) arrList.toArray(new String[arrList.size()]);
    ...
    /**
     * Test und Demonstration der Möglichkeiten des Layouters
     */
    public static void main(String[] args)
    {
        ...
        for (int intVariante = 0; intVariante < 4; intVariante++)
        {
            System.out.println("--------------------------------------------------------------------");
            System.out.println("--  Variante " + intVariante);
            System.out.println("--------------------------------------------------------------------");
            if (intVariante == 0)
            {
                table1 = new Cell[1][4];
                ...
                {
                    for (int i2 = 0; i2 < table1[i1].length; i2++)
                    {
                        table1[i1][i2] = new Cell("" + (i1 * 10) + i2);
                        table1[i1][i2].setAlignment(RIGHT_ALIGNMENT);
            ...
            if (intVariante == 2)
            {
                // einige Zellen sind null
                table1 = new Cell[3][4];

                for (int i1 = 1; i1 < table1.length; i1++)
                {
                    for (int i2 = 0; i2 < table1[i1].length; i2++)
                    {
                        table1[i1][i2] = new Cell("" + (i1 * 10) + i2);
            ...
            System.out.println("Methoden mit Beeinflussung Kopf-, Trenn- und Fuss-Linie");
            System.out.println();
            System.out.println(buildLayout(table1, NO_LINE, NO_LINE, NO_LINE));
            System.out.println();
            System.out.println(buildLayout(table1, NO_LINE, EMPTY_LINE, NO_LINE));
            System.out.println();
            System.out.println(buildLayout(table1, SINGLE_LINE, EMPTY_LINE, SINGLE_LINE));
            System.out.println();
            System.out.println(buildLayout(table1, SINGLE_LINE, SINGLE_LINE, SINGLE_LINE));
            System.out.println();
            System.out.println(buildLayout(table1, DOUBLE_LINE, SINGLE_LINE, DOUBLE_LINE));

            // -----------------------------------------------------------

            System.out
                    .println("Methoden mit Beeinflussung Kopf-, Kopfzeilen-Trenn-, Trenn-, Fusszeilen-Trenn- und Fuss-Linie");
            System.out.println();
            System.out.println(buildLayout(table1, NO_LINE, SINGLE_LINE, NO_LINE, NO_LINE, NO_LINE));
            System.out.println();
            System.out.println(buildLayout(table1, NO_LINE, SINGLE_LINE, EMPTY_LINE, EMPTY_LINE,
                    NO_LINE));
            System.out.println();
            System.out.println(buildLayout(table1, SINGLE_LINE, DOUBLE_LINE, EMPTY_LINE, SINGLE_LINE,
                    SINGLE_LINE));
            System.out.println();
            System.out.println(buildLayout(table1, SINGLE_LINE, DOUBLE_LINE, SINGLE_LINE,
                    SINGLE_LINE, SINGLE_LINE));
            System.out.println();
            System.out.println(buildLayout(table1, DOUBLE_LINE, DOUBLE_LINE, SINGLE_LINE,
                    DOUBLE_LINE, DOUBLE_LINE));

            // -----------------------------------------------------------

            System.out.println("Addieren Kopf");
            System.out.println();

            table1 = addHeader(table1, new String[] { "H0", "H1", "H2", "H3" });
            ...
            System.out.println("Addieren Fuss");
            System.out.println();

            table1 = addFooter(table1, new String[] { "F0", "F1", "F2", "F3" });
            ...
            System.out.println("Addieren Spalte laufende Nummer Kopf: ja/nein, Fuss: ja /nein, Start mit 0 oder 1");
            System.out.println();

            table1 = addCountCol(table1, // Tabelle
                    0,// zählen ab
                    1, // Lücke oben
                    "lfd", // Text oben
                    1, // Lücke unten
        ...
        // -----------------------------------------------------------
        //
        // Demo hierarchische Strukturen
        //
        // -----------------------------------------------------------

        System.out.println("Demo hierarchische Strukturen");
        System.out.println();

        table1 = new Cell[][] { // -
        { new Cell("00"), new Cell("01") }, // -
                { new Cell("10"), new Cell("11") } // -
        };
        table1 = addHeader(table1, new String[] { "H0", "H1" });
        for (int i = 1; i < 5; i++)
        {
            String innerTableStr = buildLayout(table1, SINGLE_LINE, DOUBLE_LINE, SINGLE_LINE,
                    SINGLE_LINE, SINGLE_LINE);

            // letztes Umbruch-Zeichen abschneiden, dirty trick
            innerTableStr = innerTableStr.substring(0, innerTableStr.length() - 1);

            table1 = new Cell[][] {
                    { new Cell("" + i), new Cell(innerTableStr)
            }, { new Cell("" + i), new Cell(innerTableStr)
            }
            };
            table1 = addHeader(table1, new String[] { "H0", "H1" });
        ...
        System.out.println(buildLayout(table1, SINGLE_LINE, DOUBLE_LINE, SINGLE_LINE, SINGLE_LINE,
                SINGLE_LINE));
        // -----------------------------------------------------------
        //
        // Demo colspan
        ...
        // 0 - 1
        table1[0][0] = new Cell("c2");
        table1[0][0].setColspan(2);

        // 2 - 3
        table1[0][1] = new Cell("c2 c2 c2 c2 c2 c2");
        table1[0][1].setColspan(2);

        // 4 - 6
        table1[0][2] = new Cell("c3");
        table1[0][2].setColspan(3);

        // 7 - 9
        table1[0][3] = new Cell("c3 c3 c3 c3 c3 c3 c3 c3 c3 c3 c3 c3 c3");
        table1[0][3].setColspan(3);

        // 10 - 13
        table1[0][4] = new Cell("c4");
        table1[0][4].setColspan(4);

        System.out.println(buildLayoutColspan(table1, SINGLE_LINE, SINGLE_LINE, SINGLE_LINE));
        System.out.println();
        System.out.println(buildLayoutColspan(table1, DOUBLE_LINE, DOUBLE_LINE, SINGLE_LINE,
                DOUBLE_LINE, DOUBLE_LINE));
        System.out.println();
