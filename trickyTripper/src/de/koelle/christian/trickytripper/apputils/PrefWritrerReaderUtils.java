...
public class PrefWritrerReaderUtils {
    ...
    public static ExportSettings loadExportSettings(SharedPreferences prefs) {
        ...
        exportSettings.setFormatCsv(prefs.getBoolean(PREFS_VALUE_EXPORT_SETTINGS_EXPORT_FORMAT_CSV, Boolean.TRUE));
        exportSettings.setFormatTxt(prefs.getBoolean(PREFS_VALUE_EXPORT_SETTINGS_EXPORT_FORMAT_TXT, Boolean.TRUE));
